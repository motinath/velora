...
class SchematicRenderer:
    def render(self, graph: CircuitGraph) -> Dict[str, Any]:
        ...
        svg_lines = [
            f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {width} {height}" width="100%" height="100%" style="background-color: #ffffff;">',
            '<!-- Grid Background -->',
            '  <defs>',
        ...
        for nl in nodes_layout:
            ...
            if ctype == "PMOS":
                # Draw PMOS symbol
                svg_lines.extend([
                    f'    <line x1="-20" y1="0" x2="-10" y2="0" stroke="#0f172a" stroke-width="2" />', # Gate line out
                    f'    <line x1="-10" y1="-20" x2="-10" y2="20" stroke="#0f172a" stroke-width="3" />', # Gate bar
                    f'    <circle cx="-5" cy="0" r="4" fill="#ffffff" stroke="#0f172a" stroke-width="2" />', # PMOS bubble
                    f'    <line x1="0" y1="-20" x2="0" y2="20" stroke="#0f172a" stroke-width="3" />', # Channel bar
                    f'    <line x1="0" y1="-15" x2="20" y2="-15" stroke="#0f172a" stroke-width="2" />', # Source line
                    f'    <line x1="0" y1="15" x2="20" y2="15" stroke="#0f172a" stroke-width="2" />', # Drain line
                ...
                # Draw NMOS symbol
                svg_lines.extend([
                    f'    <line x1="-20" y1="0" x2="0" y2="0" stroke="#0f172a" stroke-width="2" />', # Gate line
                    f'    <line x1="0" y1="-20" x2="0" y2="20" stroke="#0f172a" stroke-width="3" />', # Gate bar
                    f'    <line x1="10" y1="-20" x2="10" y2="20" stroke="#0f172a" stroke-width="3" />', # Channel bar
                    f'    <line x1="10" y1="-15" x2="30" y2="-15" stroke="#0f172a" stroke-width="2" />', # Drain line
                    f'    <line x1="10" y1="15" x2="30" y2="15" stroke="#0f172a" stroke-width="2" />', # Source line
                    f'    <polygon points="12,15 22,10 22,20" fill="#0f172a" />', # Source Arrow pointing out
                ...
                svg_lines.extend([
                    f'    <circle cx="0" cy="0" r="6" fill="#eab308" stroke="#ffffff" stroke-width="2" />',
                ...
                svg_lines.extend([
                    f'    <rect x="-10" y="-15" width="20" height="30" fill="#ffffff" stroke="#64748b" stroke-width="2" />',
                    f'    <line x1="0" y1="-25" x2="0" y2="-15" stroke="#0f172a" stroke-width="2" />',
                    f'    <line x1="0" y1="15" x2="0" y2="25" stroke="#0f172a" stroke-width="2" />',
