...
export function GlobalSidebar({
  ...
  return (
    <div 
      className={`h-full border-r border-slate-100 bg-white flex flex-col justify-between z-20 shrink-0 overflow-hidden transition-all duration-300 ease-in-out ${
        isOpen ? 'w-[260px] opacity-100 p-4' : 'w-0 opacity-0 p-0 border-none'
      }`}
    >
